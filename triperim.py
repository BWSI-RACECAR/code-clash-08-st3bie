...
class Solution:
    def tri_perimeter(self,v1, v2, v3):
        ...
        edge1 = (v1[0]-v2[0])*(v1[0]-v2[0])+(v1[1]-v2[1])*(v1[1]-v2[1])
        edge2 = (v3[0]-v2[0])*(v3[0]-v2[0])+(v3[1]-v2[1])*(v3[1]-v2[1])
        edge3 = ((v3[0]-v1[0])*(v3[0]-v1[0])+(v3[1]-v1[1])*(v3[1]-v1[1]))
        
        return edge1**0.5 + edge2**0.5 + edge3**0.5
